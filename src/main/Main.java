...
//		try {
			...
			ArrayList<ActionElement> seqLeft00 = r1.getSequence("Data/TumKitchenData/righthand-0-11-condensed.csv");
			ArrayList<ActionElement> seqRight00 = r2.getSequence("Data/TumKitchenData/righthand-0-7-condensed-abstracted.csv");
